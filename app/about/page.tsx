  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="max-w-4xl mx-auto bg-white/90 dark:bg-slate-800/90 backdrop-blur-md rounded-xl p-8 border border-slate-200 dark:border-slate-700">
          ...
          <section className="mb-12">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-slate-700 dark:text-slate-300">
                  Our model is trained on the Human Against Machine with 10000 training images (HAM10000) dataset, a on
                  the Human Against Machine with 10000 training images (HAM10000) dataset, a large collection of
                  dermatoscopic images of common pigmented skin lesions. This dataset includes over 10,000 high-quality
                  images across seven different diagnostic categories:
                </p>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc list-inside text-slate-700 dark:text-slate-300 space-y-1 mb-4">
              ...
              <li>Data augmentation to improve generalization (rotation, flipping, color jittering)</li>
              <li>Class balancing to handle the imbalanced nature of the HAM10000 dataset</li>
              <li>Fine-tuning with a learning rate scheduler for optimal convergence</li>
            </ul>
            <p className="text-slate-700 dark:text-slate-300">
